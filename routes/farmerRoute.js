...
router
  .route('/')
  .post(authController.protect,authController.restrictTo('farmer'),
...
router
  .get('/', authController.protect,authController.restrictTo('farmer'), farmerController.listMyProducts);
router
  .route('/:id')
